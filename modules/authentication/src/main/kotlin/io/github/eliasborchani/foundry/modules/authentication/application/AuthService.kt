...
class AuthService(
    ...
    @Transactional
    override fun login(email: String, rawPassword: String): TokenPairDto {
    ...
    @Transactional
    override fun refresh(refreshToken: String): TokenPairDto {
    ...
    private fun issueTokenPair(userId: UUID, email: String): TokenPairDto {
        val now = Instant.now()
